    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame == null)
            {
                ...
                try
                {
                    App.Character = await PersistentModel.ReadObject("Default.xml");
                }
                catch (Exception e)
                {
                    System.Diagnostics.Debug.WriteLine("Deserialization failed, " + e.ToString());
        ...
        private async void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            try
            {
                await PersistentModel.WriteObject(App.Character, FileName);
            }
            catch (Exception)
            {
                TryRename = true;
            ...
            if (TryRename == true)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Failed save rename failed: " + Ex);
                    TryDelete = true;
                }
            }
            if (TryDelete == true)
